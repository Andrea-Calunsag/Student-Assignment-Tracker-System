# Program: Student Assignment Tracker System
# Author: Group 6
# Subject: Computer Science
# Description: A Python program that allows users to add, view, and mark assignments as done using functions, loops, and input validation
# Date: May 2026
